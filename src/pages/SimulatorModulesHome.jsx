...
const SimulatorModulesHome = () => {
  ...
  const subHeaderDesc = {
    emission: "Select your emission data simulation interface — IoT device sync or API gateway relay.",
    reduction: "Select your reduction modeling interface — IoT device sync or API gateway relay."
  };
            ...
            <div style={styles.grid}>
              {mainModules.map((m) => (
                <div
                  ...
                  onClick={() => { setSelectedModule(m.id); setHovered(null); }}
                >
                  <div>
          ...
          <>
            <div style={styles.breadcrumb}>
              <button
                ...
                onClick={() => { setSelectedModule(null); setHovered(null); }}
              >
                ← Back
              </button>
            ...
            <div style={styles.subHeader}>
              <div style={styles.subLabel}>{subHeaderLabel[selectedModule]}</div>
