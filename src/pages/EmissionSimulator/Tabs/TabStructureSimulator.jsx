...
const TabStructureSimulator = () => {
  ...
  const styles = {
    container: {
      ...
      padding: 0,
      background:
        "linear-gradient(135deg, #0f172a 0%, #1e293b 50%, #1a1f2e 100%)",
      overflow: "auto",
    },
    backBtn: {
      position: "absolute",
  ...
  return (
    <div style={styles.container}>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  "--gradient-from": tab.gradient.includes("blue")
                    ? "#60a5fa"
                    : "#a855f7",
                  "--gradient-to": tab.gradient.includes("green")
                    ? "#34d399"
                    : "#06b6d4",
                }}
                onMouseEnter={(e) => {
      ...
      <div style={styles.contentContainer}>
        <div style={styles.tabContentActive}>{currentTab?.component}</div>
      </div>
