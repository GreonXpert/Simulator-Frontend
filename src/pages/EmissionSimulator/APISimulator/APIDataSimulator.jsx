...
const APIDataSimulator = () => {
  ...
  const _requiresScope12Data = () =>
    getCurrentFields().includes("BuildingTotalS1_S2");

  const _fetchScope12Total = async () => {
    if (!clientId) {
      log("❌ Client Reference required", "err");
      return;
    }
  ...
  const getCurrentFields = () => {
    ...
    if (cat.activities && cat.activities.length > 0)
      return selectedActivity
        ? cat.fields[selectedActivity]?.[selectedTier] || []
        : [];
  ...
  const sendOnce = async () => {
    if (!baseUrl || !clientId || !nodeId || !scopeId) {
      log("Configuration incomplete — fill all fields", "err");
      return;
    }
    if (!apiKey) {
      log(
        "❌ API Key is required — enter your DC_API key in Credential Secret",
        "err",
      );
      return;
    }
  ...
  const hasActivityField = () => {
    const c = scopeConfig[selectedScope][selectedCategory];
    return c?.activities && c.activities.length > 0;
  };
      ...
      <div style={styles.pageShell}>
        ...
        <header style={styles.header}>
          ...
          <h1 style={styles.title}>
            API Vector <span style={styles.italic}>Simulator</span>
          </h1>
        </header>
        ...
        <div style={styles.gridOuter}>
          <div className="main">
            ...
            <div style={styles.card}>
              ...
              <div style={styles.grid}>
                <div>
                  <label style={styles.label}>Scope Ref</label>
                  <select
                    style={styles.select}
                    value={selectedScope}
                ...
                <div>
                  <label style={styles.label}>Category Ref</label>
                  <select
                    style={styles.select}
              ...
              <div style={styles.grid}>
                {hasActivityField() && (
                  <div>
                    <label style={styles.label}>Activity Node</label>
                    <select
                      style={styles.select}
                ...
                <div>
                  <label style={styles.label}>Methodology Tier</label>
                  <select
                    style={styles.select}
                    value={selectedTier}
            ...
            <div style={styles.card}>
              ...
              <label style={styles.label}>Base URL endpoint</label>
              <input
                style={styles.input}
                value={baseUrl}
              ...
              <div style={styles.grid}>
                ...
                <div>
                  <label style={styles.label}>Node Reference</label>
                  <input
                    style={styles.input}
                    value={nodeId}
              ...
              <div style={styles.grid}>
                ...
                <div>
                  <label style={styles.label}>Credential Secret</label>
                  <input
                    style={styles.input}
                    type="password"
                    value={apiKey}
              ...
              <div style={styles.urlPreview}>
                ...
                <div>
                  ...
                  {`${baseUrl}/clients/${clientId || "•"}/nodes/${nodeId || "•"}/scopes/${scopeId || "•"}/api-data`}
                </div>
                <div
                  style={{
                    marginTop: "8px",
